...
class HouseholdChemicals(Product):
    ...
    """
    def __init__(self, name, price, hazardous_warning):
        super().__init__(name, price)
        self.hazardous_warning = hazardous_warning
        
    def get_details(self):
        return f"Бытовая химия: {self.name}, Цена: {self.price} руб., Опасно: {self.hazardous_warning}"